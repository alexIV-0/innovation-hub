...
export const dict = {
  ru: {
    ...
    mOpenDrive: "Открыть на Google Drive",
    ...
    driveUnavailable: "Google Drive недоступен для этого проекта",
    driveEmpty: "Папок пока нет — файлы появятся после синхронизации с Drive",
  },
  en: {
    langName: "EN",
    langTitle: "English",
    ...
    mOpenDrive: "Open in Google Drive",
    ...
    driveUnavailable: "Google Drive is unavailable for this project",
    driveEmpty: "No folders yet — files will appear after Drive sync",
  },
} as const
